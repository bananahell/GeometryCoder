...
function dec = decodeGeometryInter(dec)
...
cabac = getCABAC();
cabac = initCABACDecoder(cabac, dec.params.BACParams, 1);
...
[dec.pointCloud, dec.geometryCube, cabac] = decodeGeoCubeInter(dec.geometryCube, dec, [], cabac, 1, limit + 1);
