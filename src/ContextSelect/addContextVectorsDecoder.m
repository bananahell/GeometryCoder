...
%% BACContexts_3DT
dec.params.BACParams.contextVector4DT = fullContextVector(76:84);
dec.params.BACParams.contextVector3DT = fullContextVector(85:93);
dec.params.BACParams.contextVector2DT = fullContextVector(94:99);
