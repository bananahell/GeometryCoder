...
function cabac_out = encodeGeoCubeInter(geoCube, enc,cabac_in, currAxis, iStart,iEnd, Y)
...
if (testDyadicDecomposition)
    ...
    if (encodeYleft && (lEnd > lStart))
        ...
        cabacDyadic = encodeGeoCubeInter(geoCube, enc,cabacDyadic, currAxis, lStart,lEnd, Yleft);    
    ...
    if (encodeYright && (rEnd > rStart))
        ...
        cabacDyadic = encodeGeoCubeInter(geoCube, enc,cabacDyadic, currAxis, rStart,rEnd, Yright);  
