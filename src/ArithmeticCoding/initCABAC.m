...
function cabac = initCABAC(cabac, BACParams, interCoding, test3DOnlyContextsForInter)
...
nC_2D          = BACParams.numberOfContexts2DMasked;

nC_3DOr        = BACParams.numberOfContexts3DORImages;
nC_2DOr        = BACParams.numberOfContexts2DORImages;

nC_4DT = BACParams.numberOfContexts4DTORImages;
nC_3DT = BACParams.numberOfContexts3DTORImages;
nC_2DT = BACParams.numberOfContexts2DTORImages;
...
if (interCoding == 0)
    ...
    cabac.BACContexts_3DT_ORImages    = initCountContexts_4D(nC_4DT, nC_3DT, nC_2DT);
