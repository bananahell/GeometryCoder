...
newFolder{k}       = 'david9';
dataFolder{k}      = [datasetFolder 'david9\ply\'];
workspaceFolder{k} = [outputFolder 'david9\4D_3D\'];
params{k}          = [1 0];
frameStart{k}      = 1;
frameEnd{k}        = 5;
...
newFolder{k}       = 'david9';
dataFolder{k}      = [datasetFolder 'david9\ply\'];
workspaceFolder{k} = [outputFolder 'david9\4D\'];
params{k}          = [0 0];
frameStart{k}      = 1;
frameEnd{k}        = 5;
...
newFolder{k}       = 'david9';
dataFolder{k}      = [datasetFolder 'david9\ply\'];
workspaceFolder{k} = [outputFolder 'david9\4D_3D_Fast\'];
params{k}          = [1 1];
frameStart{k}      = 1;
frameEnd{k}        = 5;
...
parentFolder{k}    = outputFolder;
newFolder{k}       = 'phil9';
dataFolder{k}      = [datasetFolder 'phil9\ply\'];
workspaceFolder{k} = [outputFolder 'phil9\4D_3D\'];
params{k}          = [1 0];
frameStart{k}      = 1;
frameEnd{k}        = 5;
...
newFolder{k}       = 'phil9';
dataFolder{k}      = [datasetFolder 'phil9\ply\'];
workspaceFolder{k} = [outputFolder 'phil9\4D\'];
params{k}          = [0 0];
frameStart{k}      = 1;
frameEnd{k}        = 5;
...
newFolder{k}       = 'phil9';
dataFolder{k}      = [datasetFolder 'phil9\ply\'];
workspaceFolder{k} = [outputFolder 'phil9\4D_3D_Fast\'];
params{k}          = [1 1];
frameStart{k}      = 1;
frameEnd{k}        = 5;
