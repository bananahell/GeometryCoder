...
workspaceFolder{k} = [outputFolder_FullBodies 'soldier\4DSingle_NoME\'];
params{k}          = [1 0];
frameStart{k}      = 0537;
frameEnd{k}        = 0557;
...
newFolder{k}       = 'soldier';
dataFolder{k}      = [datasetFolder_FullBodies 'soldier\Ply\'];
workspaceFolder{k} = [outputFolder_FullBodies 'soldier\3DSingle\'];
params{k}          = [0 0];
frameStart{k}      = 0537;
frameEnd{k}        = 0557;
...
newFolder{k}       = 'soldier';
dataFolder{k}      = [datasetFolder_FullBodies 'soldier\Ply\'];
workspaceFolder{k} = [outputFolder_FullBodies 'soldier\4DSingle_ME\'];
params{k}          = [1 1];
frameStart{k}      = 0537;
frameEnd{k}        = 0557;
...
for k = 1:1:N
    for i = frameStart{k}:1:frameEnd{k}
        ...
        encStartTime = tic;
        enc = encodePointCloudGeometry_Inter(inputFile, prevFile, binaryFile,params{k}(1),params{k}(2));
