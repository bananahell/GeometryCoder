...
% seq = {'loot_vox10', 'loot_vox10', 'soldier_vox10', ...
%     'soldier_vox10', 'longdress_vox10', 'longdress_vox10'};
% seq = {'andrew9', 'david9', 'phil9', 'ricardo9', 'sarah9'};%, ...
%     'andrew9', 'david9', 'phil9', 'ricardo9', 'sarah9',};
seq = {'man2', 'man2', 'man2'};
frame = {200, 201, 202};
pc = {['man2_' num2str(frame{1},'%03d')], ...
    ['man2_' num2str(frame{2},'%03d')], ...
    ['man2_' num2str(frame{3},'%03d')]};
% frame = {1201, 1202, 736, 737, 1301, 1302};
% pc = {['loot_vox10_' num2str(frame{1},'%04d')], ...
%     ['loot_vox10_' num2str(frame{2},'%04d')], ...
%     ['soldier_vox10_' num2str(frame{3},'%04d')], ...
%     ['soldier_vox10_' num2str(frame{4},'%04d')], ...
%     ['longdress_vox10_' num2str(frame{5},'%04d')], ...
%     ['longdress_vox10_' num2str(frame{6},'%04d')]};
% pc = {['frame' num2str(frame{1},'%04d')], ...
%     ['frame' num2str(frame{1},'%04d')], ...
%     ['frame' num2str(frame{1},'%04d')], ...
%     ['frame' num2str(frame{1},'%04d')], ...
%     ['frame' num2str(frame{1},'%04d')]};
%     ['frame' num2str(frame{2},'%04d')], ...
%     ['frame' num2str(frame{2},'%04d')], ...
%     ['frame' num2str(frame{2},'%04d')], ...
%     ['frame' num2str(frame{2},'%04d')], ...
%     ['frame' num2str(frame{2},'%04d')]};
