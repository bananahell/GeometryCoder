...
function cabac_out = encodeImageBAC_withMask_3DContexts_ORImages_Inter(A,mask,Yleft,pA,cabac,testMode4D_3D, consider3DOnlyContexts)
...
if (consider3DOnlyContexts == 1)
    ...
    if (testMode4D_3D(1) == 1)
        ...
        for k = 1:1:length(idx_i)
            ...
            currCount = [0 0];
            currCount(1) = cabac4D.BACContexts_3DT_ORImages(contextNumber4D, contextNumberLeft, contextNumber2D + 1, 1);
            currCount(2) = cabac4D.BACContexts_3DT_ORImages(contextNumber4D, contextNumberLeft, contextNumber2D + 1, 2);
            ...
            %Updates the context.
            if (currSymbol == false)
                cabac4D.BACContexts_3DT_ORImages(contextNumber4D, contextNumberLeft, contextNumber2D + 1, 1) = cabac4D.BACContexts_3DT_ORImages(contextNumber4D, contextNumberLeft, contextNumber2D + 1, 1) + 1;
                cabac4D.BACContexts_3D_ORImages(contextNumberLeft, contextNumber2D_3DOnly + 1, 1)            = cabac4D.BACContexts_3D_ORImages(contextNumberLeft, contextNumber2D_3DOnly + 1, 1) + 1;
            else
                cabac4D.BACContexts_3DT_ORImages(contextNumber4D, contextNumberLeft, contextNumber2D + 1, 2) = cabac4D.BACContexts_3DT_ORImages(contextNumber4D, contextNumberLeft, contextNumber2D + 1, 2) + 1;
                cabac4D.BACContexts_3D_ORImages(contextNumberLeft, contextNumber2D_3DOnly + 1, 2)            = cabac4D.BACContexts_3D_ORImages(contextNumberLeft, contextNumber2D_3DOnly + 1, 2) + 1;
            end
        end
    ...
    if (testMode4D_3D(2) == 1)
        ...
        for k = 1:1:length(idx_i)
            ...
            %Gets the current count for this context.
            currCount = [0 0];
            currCount(1) = cabac3D.BACContexts_3D_ORImages(contextNumberLeft, contextNumber2D_3DOnly + 1, 1);
            currCount(2) = cabac3D.BACContexts_3D_ORImages(contextNumberLeft, contextNumber2D_3DOnly + 1, 2);
            ...
            %Updates the context.
            if (currSymbol == false)
                cabac3D.BACContexts_3DT_ORImages(contextNumber4D, contextNumberLeft, contextNumber2D + 1, 1) = cabac3D.BACContexts_3DT_ORImages(contextNumber4D, contextNumberLeft, contextNumber2D + 1, 1) + 1;
                cabac3D.BACContexts_3D_ORImages(contextNumberLeft, contextNumber2D_3DOnly + 1, 1)            = cabac3D.BACContexts_3D_ORImages(contextNumberLeft, contextNumber2D_3DOnly + 1, 1) + 1;
            else
                cabac3D.BACContexts_3DT_ORImages(contextNumber4D, contextNumberLeft, contextNumber2D + 1, 2) = cabac3D.BACContexts_3DT_ORImages(contextNumber4D, contextNumberLeft, contextNumber2D + 1, 2) + 1;
                cabac3D.BACContexts_3D_ORImages(contextNumberLeft, contextNumber2D_3DOnly + 1, 2)            = cabac3D.BACContexts_3D_ORImages(contextNumberLeft, contextNumber2D_3DOnly + 1, 2) + 1;
            end
        end
