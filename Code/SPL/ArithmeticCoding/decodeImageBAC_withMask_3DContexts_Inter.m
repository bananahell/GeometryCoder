...
if (bit == 0) %4D Contexts were used!
    ...
    for k = 1:1:length(idx_i)
        ...
        %Gets the current count for this context.
        currCount = [0 0];
        currCount(1) = cabac.BACContexts_3D(contextNumberLeft, contextNumber2D_3DOnly + 1, 1);
        currCount(2) = cabac.BACContexts_3D(contextNumberLeft, contextNumber2D_3DOnly + 1, 2);
